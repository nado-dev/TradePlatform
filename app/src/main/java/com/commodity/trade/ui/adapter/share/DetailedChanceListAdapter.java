 ...
 * @author Aaron
 */
public class DetailedChanceListAdapter extends RecyclerView.Adapter {
    ...
    public DetailedChanceListAdapter(Context context, List <ShareBeanMuti.DataBean> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == NO_MORE_TO_LOAD) {
            return new DetailedChanceListAdapter.NoMoreViewHolder(noMoreToLoad);
        } else {
            return new DetailedChanceListAdapter.ItemViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (getItemViewType(position) == NO_MORE_TO_LOAD) {
            final DetailedChanceListAdapter.NoMoreViewHolder recyclerViewHolder = (DetailedChanceListAdapter.NoMoreViewHolder) holder;
        }
        else{
            final DetailedChanceListAdapter.ItemViewHolder recyclerViewHolder = (DetailedChanceListAdapter.ItemViewHolder) holder;
            ...
            recyclerViewHolder.orderItemStatus.setText(String.valueOf(status));
            recyclerViewHolder.itemView.setOnClickListener(v->{
                Intent intent = new Intent(context, GetAllShareCodeActivity.class);
